...
public class GenUtils {
    ...
    public static void initTable(GenTable genTable, String operName)
    {
        ...
        genTable.setPackageName(GenProperties.PACKAGE_NAME);
        genTable.setModuleName(getModuleName(GenProperties.PACKAGE_NAME));
        genTable.setBusinessName(getBusinessName(genTable.getTableName()));
        genTable.setFunctionName(replaceText(genTable.getTableComment()));
        genTable.setFunctionAuthor(GenProperties.AUTHOR);
        genTable.setOrmType(GenProperties.ORM_TYPE);
        genTable.setGenExport("0");
    ...
    {
        boolean autoRemovePre = GenProperties.AUTO_REMOVE_PRE;
        String tablePrefix = GenProperties.TABLE_PRE_FIX;
