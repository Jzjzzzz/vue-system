...
public class VelocityUtils
{
    ...
    /** mybatis空间路径 */
    private static final String MYBATIS_PATH = "main/java/com/jzj/base/web/mapper/xml";
    /** 默认上级菜单，系统工具 */
    ...
    public static VelocityContext prepareContext(GenTable genTable)
    {
        ...
        velocityContext.put("genExport", genTable.getGenExport());
    ...
    public static String getFileName(String template, GenTable genTable)
    {
        ...
        {
            fileName = StringUtils.format("{}/pojo/entity/{}.java", javaPath, genTable.getSubTable().getClassName());
        }
